...
// VideoStoryboard's recording-probe rationale). 200/206 alone is insufficient — an
...
// unchanged. Only a matching content type → seed READY; 404 or any error → do
// nothing; never a fabricated link.
//
