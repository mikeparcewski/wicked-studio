/**
 * The skills wire MIRROR is pinned byte-for-byte to the vendored 0.38.0 contract (FIX-IT-ALL L8-0a: the 0.36.0 skills block plus the additive `claude-dispatch` / `unchanged` / `baseSkill` lines).
 *
