...
describe('gateVerdict helpers', () => {
  ...
  it('checkOutcome: exit code, timeout and spawn error in that priority', () => {
    const base = { name: 'test', argv: [], source: '', exitCode: 0, timedOut: false, spawnError: null, durationMs: 1, stdoutTail: null, stderrTail: null, classification: null, preExisting: [], regressions: [] };
